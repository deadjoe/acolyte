...
class TestPromptService:
    ...
    async def test_create_prompt_with_file(self, service):
        ...
        with patch("acolyte.core.services.prompt_service.run_in_session", side_effect=mock_run_session), \
             ...
             patch("acolyte.core.services.prompt_service.extract_model_data", return_value=mock_prompt):
